...
// `x + 1/3` is x + 0 by the time rcas sees it: the server says so.
function warnings(cell, body) {
  for (const text of cell.warnings || []) body.append(el("div", "warning", `warning: ${text}`));
}
