...
module RCAS
  ...
  module Background
    ...
    READING = {
      ...
      matrix: ["Matrix (mathematics)", "Gaussian elimination", "Eigenvalues and eigenvectors", "Strassen algorithm", "Computational complexity of matrix multiplication", "Chinese remainder theorem", "Hadamard's inequality"],
